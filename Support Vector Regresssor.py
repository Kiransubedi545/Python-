...
# Normalize features (very important for SVR)
...
plt.title("Actual vs Predicted - SVR (Scaled)")
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.title("Residuals Distribution - SVR (Scaled)")
...
print("\n🔍 Classification Metrics (Normal vs High Strength - SVR):")
