...
# Normalize features (not required for Decision Tree, but keeping for consistency)
...
plt.title("Actual vs Predicted - Decision Tree (Scaled)")
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.title("Residuals Distribution - Decision Tree (Scaled)")
...
print("\n Classification Metrics (Normal vs High Strength - Decision Tree):")
