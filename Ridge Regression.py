...
plt.title("Actual vs Predicted - Ridge Regression (Scaled)")
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.title("Residuals Distribution - Ridge Regression (Scaled)")
...
print("\n Classification Metrics (Normal vs High Strength - Ridge):")
