...
# Normalize features (not mandatory for CatBoost, but included for consistency)
scaler = StandardScaler()
X_train_scaled = scaler.fit_transform(X_train)
X_test_scaled = scaler.transform(X_test)

# Train CatBoost Regressor
model = CatBoostRegressor(verbose=0, iterations=100, learning_rate=0.1, random_state=42)
...
print("\n🔍 Classification Metrics (Normal vs High Strength - CatBoost):")
