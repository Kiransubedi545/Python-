...
# Feature scaling (not mandatory for XGBoost but added for consistency)
...
plt.title("Actual vs Predicted - XGBoost (Scaled)")
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.title("Residuals Distribution - XGBoost (Scaled)")
...
print("\n🔍 Classification Metrics (Normal vs High Strength - XGBoost):")
